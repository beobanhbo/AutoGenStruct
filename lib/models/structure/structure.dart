...
import 'package:auto_gen_struct/network/download_file.dart';

abstract class Structure implements CreateMethod {
...
class FileStruct extends Structure {
  ...
  Future<void> create(String path) async {
    if (url != null) {
      await DownloadFile()
          .createFileFromUrl(url: url!, filename: name, path: path);
    }
